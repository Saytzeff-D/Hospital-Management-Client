    ...
    return(
        <div>
            ...
            <div className="w3-bar w3-top w3-blue w3-large" style={{zIndex: 4}}>
                ...
                <span className='w3-right p-2 w3-hide-small font-weight-bold' onClick={()=>{navigate('/views/staffLogin')}} style={{cursor: 'pointer'}}>Logout <i className='fa fa-power-off'></i></span>
            </div>
            {/* SideNav Menu */}
